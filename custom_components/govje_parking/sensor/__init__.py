...
from .diagnostic import ENTITY_DESCRIPTIONS as DIAGNOSTIC_DESCRIPTIONS, GOVJEParkingDiagnosticSensor
...
async def async_setup_entry(
    ...
    entities += [
        GOVJEParkingDiagnosticSensor(coordinator=coordinator, entity_description=desc)
