# Getting Started with GOVJE Parking

This guide will help you install and set up the GOVJE Parking custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/Migz93/ha-govje_parking`
6. Set category to "Integration"
7. Click "Add"
8. Find "GOVJE Parking" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/Migz93/ha-govje_parking/releases)
2. Extract the `govje_parking` folder from the archive
3. Copy it to `custom_components/govje_parking/` in your Home Assistant configuration directory
...
4. Select entities from "GOVJE Parking"
...
- Report issues at [GitHub Issues](https://github.com/Migz93/ha-govje_parking/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/Migz93/ha-govje_parking/discussions)
