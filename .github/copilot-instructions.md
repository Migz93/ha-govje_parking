...
- **Main code:** `custom_components/govje_parking/`
...
- `entity/` — Base entity class (`GOVJEParkingEntity`)
...
- Entity MRO: `(PlatformEntity, GOVJEParkingEntity)` — order matters
...
- Debug level: `custom_components.govje_parking: debug` in `config/configuration.yaml`
