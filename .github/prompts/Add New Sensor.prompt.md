...
- Create new sensor file in `custom_components/govje_parking/sensor/`
- Inherit from `GOVJEParkingEntity` and `SensorEntity`
...
```python
"""[Sensor description] for GOVJE Parking."""
...
class GOVJEParking[SensorName]Sensor(
    GOVJEParkingEntity,
    SensorEntity,
):
...
- Entity: `custom_components/govje_parking/sensor/[sensor_name].py`
- Platform: `custom_components/govje_parking/sensor/__init__.py`
- Translations: `custom_components/govje_parking/translations/*.json`
