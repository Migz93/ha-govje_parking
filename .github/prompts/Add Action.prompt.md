...
**File:** `custom_components/govje_parking/services.yaml`
...
Create `custom_components/govje_parking/service_actions/[action_name].py`:

```python
"""[Action name] service action for GOVJE Parking."""
...
**File:** `custom_components/govje_parking/__init__.py`
...
**File:** `custom_components/govje_parking/const.py`
...
3. Find service action: `govje_parking.[action_name]`
...
- **Service actions directory:** `custom_components/govje_parking/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/govje_parking/services.yaml` (legacy filename)
- **Icons:** `custom_components/govje_parking/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/govje_parking/translations/*.json` under `services` key (legacy)
