...
- Inherit from `GOVJEParkingEntity` and platform base class
...
- Entity: `custom_components/govje_parking/[platform]/[entity_name].py`
- Platform: `custom_components/govje_parking/[platform]/__init__.py`
