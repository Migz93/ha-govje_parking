...
- **`entity/`** - Base entity classes (inherit `GOVJEParkingEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, GOVJEParkingEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import GOVJEParkingEntity`
